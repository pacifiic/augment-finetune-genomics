# /media/leelabsg-storage1/moonwon/personalized-expression-benchmark/consensus/merge.py
import os

IN_BASE  = "/path/to/1.alphagenome_make_fasta_left_half/output_dir"
OUT_BASE = "/path/to/output_dir_for_left_half"

TARGET_LEN = 524288 + 1  # 524,289
...
def adjust_right_pole(seq: str, target_len: int) -> str:
    n = len(seq)
    if n == target_len:
        return seq
    elif n < target_len:
...
def process_individual(indiv: str):
    ...
    for fname in os.listdir(in_dir):
        ...
        adj = adjust_right_pole(seq, TARGET_LEN)
