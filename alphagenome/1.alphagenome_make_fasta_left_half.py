# /media/leelabsg-storage1/moonwon/personalized-expression-benchmark/consensus/make_consensus_enformer_alphagenome_TSS_is_at_R.py
...
REF_DIR = "ref"
INDS = "inds"
vcf_dir = "/path/to/data_preprocessing/0.vcf_cleaning/1.vcf_cleaning.sh/vcf_dir"
SEQUENCE_LENGTH = 540000
INTERVAL = 114688
...
def generate_ref(ref_fasta_dir, gene):
    ...
    start = max(1, tss - SEQUENCE_LENGTH + 1)
    end = tss
