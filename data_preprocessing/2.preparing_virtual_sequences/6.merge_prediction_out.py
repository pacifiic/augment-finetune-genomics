...
you can run the script using  'python3 6.merge_prediction_out.py'
"""
import os
import pandas as pd

input_dir = "/path/to/5.preprocessing_after_prediction/output_dir"
output_file = "/data/10.merged_virtual_sequence_pseudo_label.txt"
