...
After specifying the input and output directories in lines 65 and 66, you can run the script using 'python 9.fasta_to_vector.py.'
"""
...
def main():
    ...
    input_dir = "/path/to/8.adjust_fasta_length/output_dir"
